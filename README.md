...
- **Track any URL** — monitors visible text content and detects changes on a configurable interval
...
- **Change history** — view a full log of detected changes per tracker
- **Drag-to-reorder** — organise your trackers in any order
